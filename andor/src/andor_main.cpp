...
int main(int argc, char **argv)
{
	...
	andor_file_path+="/catkin_ws/src/ANDOR/andor/files/TableAssembly2/"; //!< The path to the uploaded AND/OR graph
	andor_file_name="TableAssembly_2";                                    //!< The name of the uploaded AND/OR graph
